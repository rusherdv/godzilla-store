...
const Footer = () => {
    ...
    return (
    <div className='w-full bg-[#5c6ac4] h-unit-3xl text-white flex items-center justify-between max-sm:justify-center'>
        <p className='w-3/12 ml-10 max-sm:hidden'>{t('follow')}</p>
        <div className='flex justify-around w-6/12 max-sm:w-full'>
            <a href="https://www.instagram.com/pavosgodzilla/" target='_blank'>
            ...
            <a href="https://t.me/VBucksGodzilla">
            ...
            <a href="https://discord.gg/bb45kca8M2">
        ...
        <p className='w-3/12 text-right mr-10 max-sm:hidden'>{t('security')}</p>
    </div>
  )
}
